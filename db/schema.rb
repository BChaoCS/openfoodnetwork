...
ActiveRecord::Schema.define(version: 20190321203818) do
  ...
  add_index "account_invoices", ["order_id"], name: "index_account_invoices_on_order_id", using: :btree
  add_index "account_invoices", ["user_id"], name: "index_account_invoices_on_user_id", using: :btree
  ...
  add_index "billable_periods", ["account_invoice_id"], name: "index_billable_periods_on_account_invoice_id", using: :btree
  ...
  add_index "product_distributions", ["distributor_id"], name: "index_product_distributions_on_distributor_id", using: :btree
  add_index "product_distributions", ["enterprise_fee_id"], name: "index_product_distributions_on_enterprise_fee_id", using: :btree
  add_index "product_distributions", ["product_id"], name: "index_product_distributions_on_product_id", using: :btree
